...
<RequestExample>
```bash cURL
curl -X POST 'https://api.serialized.xyz/v1/token/sparklines' -H 'Authorization: YOUR_API_KEY' -H 'Content-Type: application/json' -d '{"chain": "evm:8453", "pools": ["0x0ca6485b7e9cf814a3fd09d81672b07323535b64"], "timeframe": "24h"}'
```
</RequestExample>
