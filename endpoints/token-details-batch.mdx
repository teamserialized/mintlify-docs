---
openapi: '/openapi.json POST /v1/token'
...
`POST /v1/token` · **1 per item credit**
...
<Note>Each item's payload is identical to [`GET /v1/token`](/endpoints/token-details), `stats24h` included.</Note>

<RequestExample>
```bash cURL
curl -X POST 'https://api.serialized.xyz/v1/token' -H 'Authorization: YOUR_API_KEY' -H 'Content-Type: application/json' -d '{"items":[{"chain":"solana","address":"DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263"},{"chain":"evm:8453","address":"0x4ed4e862860bed51a9570b96d89af5e1b0efefed"},{"chain":"solana","address":"11111111111111111111111111111112"}]}'
```
</RequestExample>
  ...
  "data": [
    {
      "data": {
        ...
        "stats24h": {
          ...
          "buys": 3318,
          "sells": 3622,
          "buyVolumeNative": 561.284919283,
          "sellVolumeNative": 549.433917116,
          "txns": 6902,
    ...
    },
    {
      "data": {
        ...
        "stats24h": {
          ...
          "sells": 647,
          "txns": 655,
          "buyVolumeNative": 0.214872041,
          "sellVolumeNative": 4.272726815,
