...
<RequestExample>
```bash cURL
curl 'https://api.serialized.xyz/v1/token/trades?chain=evm:8453&address=0x4ed4e862860bed51a9570b96d89af5e1b0efefed&pools=0x0ca6485b7e9cf814a3fd09d81672b07323535b64&limit=3' -H 'Authorization: YOUR_API_KEY'
```
</RequestExample>
