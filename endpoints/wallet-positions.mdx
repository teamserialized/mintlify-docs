...
<Note>EVM lists TRADED tokens currently held (closed positions excluded; native coin balances not tracked). `meta.summary` carries wallet-level totals + `usdBasis`.</Note>
